 ...
 * @brief       This file implements the thread table that is accessble by all the threads.
 *              This keeps a track of all the thread objects to control and handel them all.
 * @version     0.1
 * @date        2020-07-19
 * 
...
namespace RTOS{
    ...
    /**
     * @brief   This is also a singleton object. It holds the thread table that help in accessing
     *          diffrent threads. Note: Still this feature is under consideration.
     */
    class ThreadTable{
