...
public:
   ...
   */
  virtual RET_STA_E place_item_at_front(const void *const pv_item_to_queue,
                                        delay_t wait_time) = 0;
   ...
   */
  virtual void
  place_item_at_front_blocked(const void *const pv_item_to_queue) = 0;
   ...
   * time-out else eRTOSFailure.
   */
  virtual RET_STA_E place_item_at_back(const void *const pv_item_to_queue,
                                       delay_t wait_time) = 0;
   ...
   */
  virtual void
  place_item_at_back_blocked(const void *const pv_item_to_queue) = 0;
   ...
   * queue.
   *
   *          This function is same as the method: look_at_item except that this
